...
const ProductCard = ({product}: {product: ProductType}) => {
    ...
    return (
        <div className="shadow-lg rounded-lg overflow-hidden">
            ...
            {/* PRODUCT DETAILS */}
            <div className="felx-col gap-4 p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button onClick={handleAddToCart} className="ring-1 ring-gray-200 shadow-lg rounded-md px-2 py-1
                 text-sm curosor-pointer hover:text-white hover:bg-black transition-all duration-300 flex items-center gap-2">
