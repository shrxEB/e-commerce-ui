...
const ProductPage = async ({params,searchParams}: {params:Promise<{id:string}>;
    ...
    return (
        <div className="flex flex-col gap-4 lg:flex-row md:gap-12 mt-12">
            ...
            <div className="w-full lg:w-5/12 relative aspect-[2/3]">
              ...
              alt={product.name} fill className="object-contain rounded-md"/>
            </div>
            {/* DETAILS */}
            <div className="w-full lg:w-7/12 flex flex-col gap-4">
               ...
               <p className="text-gray-500 text-xs">
                ...
                . You authroize us to charge you selected payment method for the total ammount shown. All sales 
                are subject to our return and 
